...
export class SearchRecipeComponent implements OnInit {
  ...
  recepieAppid = '&app_id=6c074300';
  recepieKey = '&app_key=8f656a1cb4a3fc5f7f484f73a96cf13e';

  placesApi = 'https://api.foursquare.com/v2/venues/search?';
  clientdId = 'client_id=OSGVE012E3YXTDGE2W3SFGMJE0OVZGWUGWKXZVGH3B1P20NO';
  clientSecret = '&client_secret=E10RIRY3ANTAFAXMNY4D4ODEEG34WAAIFDXCKJ1QGRRLY502';
  version = '&v=20180323';
  near = '&near=';
  query = '&query=';
